...
def build_disordered_primitive(
    *,
    ...
    # primitive_cell.info.pop("spacegroup", None)
...
def run_train_ce(
    *,
    ...
    coefs = fit_linear_model(Xw, yw, reg) # type: ignore[arg-type]
    ...
    if k_splits >= 2:
        ...
        for train_idx, test_idx in kf.split(X):
            ...
            coefs_fold = fit_linear_model(X_tr, y_tr, reg) # type: ignore[arg-type]
