...
def run_wl_block(
    ...
    sl_comp_map, sl_struct = _build_sublattices(prototype_spec=prototype_spec, supercell_diag=supercell_diag)
    ...
    if tip is None:
        ...
        step_start = 0
        occ = _occ_from_initial_comp_map(prototype_spec=prototype_spec, supercell_diag=supercell_diag,
                                         ensemble=ensemble, initial_comp_map=spec.initial_comp_map, rng=rng)
    else:
